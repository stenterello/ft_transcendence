        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (policy == "PROTECTED") {
                if (tmpPwd) {
                    ...
                    throw new common_1.BadRequestException("No password given!!");
                }
            }
