...
let GameController = class GameController {
    constructor(gameService, gameGateway) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], GameController.prototype, "getUserHistory", null);
__decorate([
    (0, common_1.Get)('official/:user'),
    __param(0, (0, common_1.Param)("user")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], GameController.prototype, "getUserOfficialHistory", null);
