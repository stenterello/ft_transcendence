...
let AuthService = class AuthService {
    ...
    validateUser(username, pass) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.userService.findByName(username);
            if (yield this.userService.findByUser(username, pass)) {
    ...
    generateTwoFactorAuthenticationSecret(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.userService.setTwoFactorAuthenticationSecret(secret, user.id);
            return {
                secret,
                otpAuthUrl
            };
